...
async def register(
    ...
    registration = Registration(
        ...
        organization_name=getattr(user_data, 'organization_name', f"{user_data.first_name}'s Organization"),
        organization_domain=getattr(user_data, 'organization_domain', None),
